...
Inside the `docker/` directory there is a `Dockerfile` to build an image to run SegContrast. You can either build the image from scratch or download the image from docker hub by:
